  ...
  return (
    <>
      <div className={`${styles.page_wrapper} ${styles.about}`}>
        <p>
          {`At the age of 14 I started working full-time in a kitchen during summer. I stuck around
          for a bit and ended up doing this for 18 years, until February 2022. However, IT has
          always been my bigger interest. I have been interested in technology for as long as I can
          remember. I just never knew what to do in this field.`}
        </p>
        <p>
        ...
        <span style={{ display: "flex", flexDirection: "row" }}>
          <p>
            Currently employed as junior front-end developer at{" "}
            <a href="https://lemone.com/" to="https://lemone.com/" rel="noreferrer" target="_blank">
              Lemone
            </a>
            .
          </p>
