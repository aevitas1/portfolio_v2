    ...
    <div className={styles.form_wrapper}>
      ...
      >
        ...
        <div className={styles.subject}>
          ...
          <input type="text" name="user_subject" className={styles.input} required />
        </div>
        <div className={styles.message}>
          <label className={styles.form_label}>Message</label>
          <textarea name="user_message" rows={4} className={styles.input} required />
        </div>
        <div className={error ? `${styles.error} ${styles.error_display}` : styles.error}>
        ...
        >
          <input type="submit" value="Send" id={"formsubmit"} className={styles.formsubmit} />
        </div>
      </form>
      <div className={toast ? `${styles.toast} ${styles.toast_display}` : styles.toast}>
