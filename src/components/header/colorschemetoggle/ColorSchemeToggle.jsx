...
const ColorSchemeToggle = () => {
  ...
  return (
    <>
      <div
        className={toggleScheme ? `${styles.toggleIcon} ${styles.dark}` : styles.toggleIcon}
        onClick={handleClick}
      >
        <div className={styles.toggleIconInner}>
          {toggleScheme ? (
            <FaSun className={toggleScheme ? `${styles.sun} ${styles.active}` : `${styles.sun}`} />
          ) : (
            <BsMoonStarsFill
              className={toggleScheme ? `${styles.moon}` : `${styles.moon} ${styles.active}`}
            />
          )}
        </div>
      </div>
